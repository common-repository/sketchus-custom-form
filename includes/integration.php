...
class SKFOM_Integration {
	...
	public function add_service( $name, SKFOM_Service $service ) {
...
<div class="modify-card" id="Traffic Booster">
<a href="https://www.hostrider.us/traffic-booster/?wpref" title="Online Marketing"><img src="<?php echo skfom_plugin_url("/images/marketing.png"); ?>" width="100%">
</div>
<?php
		}
	}
